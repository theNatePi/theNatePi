...
[myPod](https://github.com/theNatePi/myPod), A podcast client styled like an iPod Nano!
...
- 🖥️ Electron (React + JS/CSS/HTML)
  - ⭐️ [myPod](https://github.com/theNatePi/myPod), a simple, standalone podcast client styled like an iPod Nano
- Go 🐹
...
- 📱 React Native
  - ⭐️ [Health Habitat](https://github.com/rebeccaahn/health-habitat), a health-tracking app that helps you improve using machine learning
- 🧪 C#
